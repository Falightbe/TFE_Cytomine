...
__author__          = "Linda Wang <mwang@student.ulg.ac.be>"
__contributors__    = ["Stévens Benjamin <b.stevens@ulg.ac.be>", "Marée Raphael <raphael.maree@ulg.ac.be>"]
...
software = conn.add_software("Segmentation_Deep_Model_Builder", "pyxitSuggestedTermJobService","ValidateAnnotation")
...
conn.add_software_parameter("keras_batch_size", software.id, "Number", 128, True, 1100, False)
conn.add_software_parameter("keras_n_epochs", software.id, "Number", 30, True, 1200, False)
conn.add_software_parameter("keras_shuffle", software.id, "Number", 1, True, 1300, False)
conn.add_software_parameter("keras_validation_split", software.id, "Number", 0.2, True, 1300, False)
