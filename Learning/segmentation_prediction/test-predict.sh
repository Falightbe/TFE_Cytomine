...
id_project=155192336 #150079801
working_path="/home/falight/TFE_Cytomine/Learning/tmp/prediction"
predict_terms=20202,4746,2171300,2171395 #id of term to be added to annotations produced by the segmentation model

model_file=test$zoom.pkl
zoom=2
windowsize=128
colorspace=2
njobs=10
...
verbose=0
for image in 155193792  #cytomine ids of images (within project) to work on
do
